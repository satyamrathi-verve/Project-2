  ...
  return (
    <Card title="Live preview" subtitle="Shown with sample values — nothing here is sent." bodyClassName="p-0">
      ...
      <div className="px-5 py-5">
        {body ? (
          <div
            className="max-w-none text-sm text-slate-700 [&_p]:my-2 [&_ul]:my-2 [&_ul]:list-disc [&_ul]:pl-5 [&_table]:my-2 dark:text-slate-300"
            dangerouslySetInnerHTML={{ __html: renderFormattedHtml(body, invoiceTableHtml) }}
          />
        ) : (
